...
<html lang="en">
	...
	<head>
		...
		<title>
			Серьги Ballad | BOSEOK - Серьги, Кольца и другие Ювелирные изделия
		</title>
	...
	<body>
		...
		<main>
			<section class="item-container">
				<p class="small">Серьги > Ballad</p>
				<section class="item">
					<section class="item-preview">
						<div class="image">
							<img src="./assets/jewerly/Ballad.jpg" alt="preview" />
						</div>
					</section>
					<section class="text">
						<p>☆☆☆☆☆ (0)</p>
						<p class="h3 bold" id="item-name">Ballad</p>
						<p>
						...
						<p class="h2" id="item-price">₽ 9 900</p>
						<section class="sale">
							<div class="image">
