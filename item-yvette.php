...
<html lang="ru">
	...
	<head>
		...
		<title>Серьги Yvette | BOSEOK - Серьги, Кольца и другие Ювелирные изделия</title>
	...
	<body>
		...
		<main>
			<section class="item-container">
				<p class="small">Серьги > Yvette</p>
				<section class="item">
					<section class="item-preview">
						<div class="image">
							<img src="./assets/jewerly/Yvette.jpg" alt="preview" />
						</div>
					</section>
					<section class="text">
						<p>☆☆☆☆☆ (0)</p>
						<p class="h3 bold" id="item-name">Yvette</p>
						<p>
							Уникальное, неземное сияние делает их особенным украшением,
							идеально подходящим для придания любому наряду нотки мистики и
							романтики.
						</p>
						<p class="h2" id="item-price">₽ 16 900</p>
						<section class="sale">
							<div class="image">
