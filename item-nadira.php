...
<html lang="ru">
	...
	<head>
		...
		<title>
			Ожерелье Nadira | BOSEOK - Серьги, Кольца и другие Ювелирные изделия
		</title>
	...
	<body>
		...
		<main>
			<section class="item-container">
				<p class="small">HwaYang > Nadira</p>
				<section class="item">
					<section class="item-preview">
						<div class="image">
							<img src="./assets/jewerly/Nadira.jpg" alt="preview" />
						</div>
					</section>
					<section class="text">
						<p>☆☆☆☆☆ (0)</p>
						<p class="h3 bold" id="item-name">Nadira</p>
						<p>
							Созданное из изысканного жемчуга, это ожерелье является
							свидетельством роскоши и качества. Его дизайн одновременно
