...
<html lang="en">
	...
	<head>
		...
		<title>
			Кольцо Camellia Milgrain | BOSEOK - Серьги, Кольца и другие Ювелирные
			изделия
		</title>
	...
	<body>
		...
		<main>
			<section class="item-container">
				<p class="small">Кольца > Camellia Milgrain</p>
				<section class="item">
					<section class="item-preview">
						<div class="image">
							<img src="./assets/jewerly/Camellia Milgrain.jpg" alt="preview" />
						</div>
					</section>
					<section class="text">
						<p>☆☆☆☆☆ (0)</p>
						<p class="h3 bold" id="item-name">Camellia Milgrain</p>
						<p>
