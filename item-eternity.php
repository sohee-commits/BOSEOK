...
<html lang="en">
	...
	<head>
		...
		<title>
			Серьги Eternity | BOSEOK - Серьги, Кольца и другие Ювелирные изделия
		</title>
	...
	<body>
		...
		<main>
			<section class="item-container">
				<p class="small">Серьги > Eternity</p>
				<section class="item">
					<section class="item-preview">
						<div class="image">
							<img src="./assets/jewerly/Eternity.jpg" alt="preview" />
						</div>
					</section>
					<section class="text">
						<p>☆☆☆☆☆ (0)</p>
						<p class="h3 bold" id="item-name">Eternity</p>
						<p>
							Идеально подходящие для прогулки или особого случая, эти серьги
							станут ярким украшением, придающим элегантность и изысканность
							любому наряду.
						</p>
						<p class="h2" id="item-price">₽ 11 900</p>
						<section class="sale">
							<div class="image">
