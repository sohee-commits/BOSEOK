...
<html lang="ru">
	...
	<head>
		...
		<title>Серьги Lunette | BOSEOK - Серьги, Кольца и другие Ювелирные изделия</title>
	...
	<body>
		...
		<main>
			<section class="item-container">
				<p class="small">Серьги > Lunette</p>
				<section class="item">
					<section class="item-preview">
						<div class="image">
							<img src="./assets/jewerly/Lunette.jpg" alt="preview" />
						</div>
					</section>
					<section class="text">
						<p>☆☆☆☆☆ (0)</p>
						<p class="h3 bold" id="item-name">Lunette</p>
						<p>
							Идеально подходящие для вечернего выхода или особого случая, эти
							серьги станут украшением, которое добавит элегантности и
							изысканности любому наряду.
						</p>
						<p class="h2" id="item-price">₽ 12 900</p>
						<section class="sale">
							<div class="image">
