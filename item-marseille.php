...
<html lang="ru">
	...
	<head>
		...
		<title>Серьги Marseille | BOSEOK - Серьги, Кольца и другие Ювелирные изделия</title>
	...
	<body>
		...
		<main>
			<section class="item-container">
				<p class="small">Серьги > Marseille</p>
				<section class="item">
					<section class="item-preview">
						<div class="image">
							<img src="./assets/jewerly/Marseille.jpg" alt="preview" />
						</div>
					</section>
					<section class="text">
						<p>☆☆☆☆☆ (0)</p>
						<p class="h3 bold" id="item-name">Marseille</p>
						<p>
							Идеально подходящие для гламурного вечера или официального
							мероприятия, эти серьги являются свидетельством элегантности вне
							времени.
						</p>
						<p class="h2" id="item-price">₽ 13 900</p>
						<section class="sale">
							<div class="image">
