...
<html lang="en">
	...
	<head>
		...
		<title>Серьги Flair | BOSEOK - Серьги, Кольца и другие Ювелирные изделия</title>
	...
	<body>
		...
		<main>
			<section class="item-container">
				<p class="small">Серьги > Flair</p>
				<section class="item">
					<section class="item-preview">
						<div class="image">
							<img src="./assets/jewerly/Flair.jpg" alt="preview" />
						</div>
					</section>
					<section class="text">
						<p>☆☆☆☆☆ (0)</p>
						<p class="h3 bold" id="item-name">Flair</p>
						<p>
