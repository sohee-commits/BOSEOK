...
<html lang="ru">
	...
	<head>
		...
		<title>
			Ожерелье Yaretzi | BOSEOK - Серьги, Кольца и другие Ювелирные изделия
		</title>
	...
	<body>
		...
		<main>
			<section class="item-container">
				<p class="small">HwaYang > Yaretzi</p>
				<section class="item">
					<section class="item-preview">
						<div class="image">
							<img src="./assets/jewerly/Yaretzi.jpg" alt="preview" />
						</div>
					</section>
					<section class="text">
						<p>☆☆☆☆☆ (0)</p>
						<p class="h3 bold" id="item-name">Yaretzi</p>
						<p>
							Это ожерелье излучает классическую, неподвластную времени
							элегантность благодаря замысловатому дизайну и материалам
							реликвийного качества. Идеально подходит для тех, кто ценит
							очарование традиционных украшений.
						</p>
						<p class="h2" id="item-price">₽ 13 500</p>
						<section class="sale">
							<div class="image">
