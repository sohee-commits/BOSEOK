...
<html lang="ru">
	...
	<head>
		...
		<title>
			Ожерелье Orinthia | BOSEOK - Серьги, Кольца и другие Ювелирные изделия
		</title>
	...
	<body>
		...
		<main>
			<section class="item-container">
				<p class="small">HwaYang > Orinthia</p>
				<section class="item">
					<section class="item-preview">
						<div class="image">
							<img src="./assets/jewerly/Orinthia.jpg" alt="preview" />
						</div>
					</section>
					<section class="text">
						<p>☆☆☆☆☆ (0)</p>
						<p class="h3 bold" id="item-name">Orinthia</p>
						<p>
							Вдохновленное причудливой и романтичной эстетикой стимпанка, это
							ожерелье представляет собой пленительное сочетание металлов и
							драгоценных камней. Его уникальный дизайн манит и притягивает,
