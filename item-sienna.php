...
<html lang="en">
	<head>
		...
		<title>Серьги Sienna | BOSEOK - Серьги, Кольца и другие Ювелирные изделия</title>
	...
	<body>
		...
		<main>
			<section class="item-container">
				<p class="small">Серьги > Sienna</p>
				<section class="item">
					<section class="item-preview">
						<div class="image">
							<img src="./assets/jewerly/Sienna.jpg" alt="preview" />
						</div>
					</section>
					<section class="text">
						<p>☆☆☆☆☆ (0)</p>
						<p class="h3 bold" id="item-name">Sienna</p>
						<p>
							Блестящая отделка и сверкающие кристаллы создают ослепительный
