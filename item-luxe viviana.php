...
<html lang="ru">
	...
	<head>
		...
		<title>
			Кольцо Luxe Viviana | BOSEOK - Серьги, Кольца и другие Ювелирные изделия
		</title>
	...
	<body>
		...
		<main>
			<section class="item-container">
				<p class="small">Кольца > Luxe Viviana</p>
				<section class="item">
					<section class="item-preview">
						<div class="image">
							<img src="./assets/jewerly/Luxe Viviana.jpg" alt="preview" />
						</div>
					</section>
					<section class="text">
						<p>☆☆☆☆☆ (0)</p>
						<p class="h3 bold" id="item-name">Luxe Viviana</p>
						<p>
							Кольцо в знак преданности, символ глубокой и неизменной любви,
							связывающей два сердца.
						</p>
						<p class="h2" id="item-price">₽ 20 500</p>
						<section class="sale">
							<div class="image">
