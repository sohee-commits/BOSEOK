    ...
    <main>
      <main>
        <section class="about">
          ...
          <p>15 марта 2024 года важным шагом для компании BOSEOK стало добавление нового раздела на своем веб-сайте под
          ...
          <p>
            Добавление раздела "Кольца" на веб-сайте BOSEOK открывает новые возможности как для компании, так и для ее
          ...
          <p>
            ...
            процесс покупки для своих клиентов. Важно отметить, что такое обновление веб-сайта способствует укреплению
